...
const arcanaCards = [
  ...
  { id: 3, name: "III. 獵士 (The Huntress)", cost: 3, row: 1, col: 3, desc: "魔力未滿 100% 時，普通攻擊和武器技能都會造成更多傷害。" },
  ...
  // 第二行 (Row 2)
  { id: 6, name: "VI. 復仇三女神 (The Furies)", cost: 2, row: 2, col: 1, desc: "對處於你法陣中的敵人造成更多傷害。" },
  { id: 7, name: "VII. 堅忍 (Persistence)", cost: 2, row: 2, col: 2, desc: "最大生命值與最大魔力提升。" },
  { id: 8, name: "VIII. 信使 (The Messenger)", cost: 0, row: 2, col: 3, desc: "施展法陣將讓你暫時進入無敵狀態，移動速度上升。【啟用條件：啟用至少 3 張掌握值消耗相同的卡牌】" },
  ...
  // 第三行 (Row 3)
  { id: 11, name: "XI. 飛毛腿 (The Swift Runner)", cost: 1, row: 3, col: 1, desc: "奔跑的速度上升，且能穿越大部分的敵人。" },
