...
const arcanaCards = [
  ...
  { id: 2, name: "II. 逆子 (The Wayward Son)", cost: 1, row: 1, col: 2, desc: "離開地點後恢復生命；若低於 30% 生命值則效果加倍。" },
  ...
  { id: 14, name: "XIV. 起源 (Origination)", cost: 5, row: 3, col: 4, desc: "對受到至少兩種不同狀態詛咒的敵人，造成的傷害提升。" },
  ...
  { id: 19, name: "XIX. 卓越 (Excellence)", cost: 5, row: 4, col: 4, desc: "所獲祝福選項有機率包含卓越或高階級祝福。" },
  { id: 20, name: "XX. 皇后 (The Queen)", cost: 0, row: 4, col: 5, desc: "獲得雙重祝福的機率提升。【啟用條件：啟用不超過 2 張相同掌握值消耗的卡牌】" },

  // 第五行 (Row 5)
  { id: 21, name: "XXI. 命運 (The Fates)", cost: 0, row: 5, col: 1, desc: "擁有重置祝福等特定選項的能力。【啟用條件：啟用所有相鄰的卡牌】" },
  { id: 22, name: "XXII. 戰士 (The Champions)", cost: 4, row: 5, col: 2, desc: "擁有重刷祝福等特定選項的次數。" },
